...
if (gwData.protected) {
	...
	inputs[0].type = "hidden"; inputs[0].name = "name"; inputs[0].value = "sandbox";
	inputs[1].type = "hidden"; inputs[1].name = "data"; inputs[1].value = document.getElementById("edTextbox").value;
	inputs[2].type = "hidden"; inputs[2].name = "related"; inputs[2].value = gwData.related;
	inputs[3].type = "hidden"; inputs[3].name = "edittime"; /* inputs[3].value = Date.now(); */
	inputs[4].type = "submit"; inputs[4].value = "新規グリフとして\n専用エディタで編集する";
